...
2) Када се у телу метода параметар низовног типа постави тако да реферише на неки други низ.
...
public class PokretanjeZamenaParametaraPriPozivu {
   ...
   public static void main(String[] args) {
      ...
      // tipa
      System.out.println("Pokretanjeiranje metoda utrostruciSve():");
      double[] brojevi = { 1.0, 2, 3, 4.5, 5 };
