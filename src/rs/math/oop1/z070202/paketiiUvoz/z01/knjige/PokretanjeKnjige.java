...
public class PokretanjeKnjige {
      ...
      public static void main(String[] args) {
            Scanner sc = new Scanner("Горски вијенац/Његош/1954/134/Страва/Небојша Јеврић/2003/114");
            sc.useDelimiter("/");
            Knjiga k1;
            k1 = new Knjiga();
            k1.naslov = sc.next();
