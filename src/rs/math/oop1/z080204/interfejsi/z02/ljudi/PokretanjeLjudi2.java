...
public class PokretanjeLjudi2 {
      ...
      public static void main(String[] args) {
            ...
            System.out.println("dob: " + ((Kvalitet) janko).jeDobar() + " pos:" + ((Kvalitet) janko).jePosten());

            milica.predstaviSe();
            ((Deskripcija) milica).predstaviSe();
            System.out.println("dob: " + ((Kvalitet) milica).jeDobar() + " pos:" + ((Kvalitet) milica).jePosten());
